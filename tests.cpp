...
/*int main()
{
	huffman_tree testing("texts/all_ascii.txt");
	std::string teststring = testing.encode("texts/all_ascii.txt");
	std::cout << "encoding all_ascii.txt: " << teststring << std::endl;
	std::cout << "decoding encoded text: " << testing.decode(teststring) << std::endl;
	return 0;
}*/